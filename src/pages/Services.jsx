...
const services = [
  { title: 'Web Design', slug: '/web-design-etobicoke', label: 'Web Design', img: 'https://images.pexels.com/photos/196644/pexels-photo-196644.jpeg?auto=compress&cs=tinysrgb&w=800', alt: 'Designer working on a modern website', headline: 'Fast, modern websites built to convert', desc: 'Custom websites for local service businesses. Clean, fast code that ranks and turns visitors into customers.', bullets: ['Custom design, no templates', 'Mobile-first, Core Web Vitals optimized', 'SEO-ready structure from day one', 'Conversion-focused CTAs'], price: $("2,500"), cta: 'Get a Quote', img: 'https://images.pexels.com/photos/196644/pexels-photo-196644.jpeg?auto=compress&cs=tinysrgb&w=800', alt: 'Web designer working on a modern website' },
  { title: 'Local SEO', slug: '/services/search-engine-optimization', label: 'SEO', img: 'https://images.pexels.com/photos/270637/pexels-photo-270637.jpeg?auto=compress&cs=tinysrgb&w=800', alt: 'Analytics and Google search rankings on screen', headline: 'Rank on Google in your city', desc: 'Full-service local SEO. Keyword strategy, on-page optimization, Google Business Profile, link building, and monthly reporting.', bullets: ['Keyword research and local intent mapping', 'On-page and technical SEO', 'Google Business Profile optimization', 'Transparent monthly reporting'], price: $("1,000/mo"), cta: 'Get a Free Audit' },
  { title: 'Google and Facebook Ads', slug: '/google-ads', label: 'Paid Ads', img: 'https://images.pexels.com/photos/905163/pexels-photo-905163.jpeg?auto=compress&cs=tinysrgb&w=800', alt: 'Digital advertising campaign on laptop', headline: 'Paid ads that drive real leads', desc: 'We build and manage Google Search, Display, and Facebook campaigns. Every dollar tracked, every lead attributed.', bullets: ['Google Search, Display and Retargeting', 'Facebook and Instagram Ads', 'Conversion tracking from day one', 'Full monthly performance reporting'], price: $("500/mo"), cta: 'Book a Strategy Session' },
  { title: 'Generative Engine Optimization', slug: '/services/generative-engine-optimization', label: 'GEO New', img: 'https://images.pexels.com/photos/8386440/pexels-photo-8386440.jpeg?auto=compress&cs=tinysrgb&w=800', alt: 'AI technology interface', headline: 'Get found in AI-powered search', desc: 'We optimize your content and authority to appear in ChatGPT, Perplexity, and Google AI Overviews.', bullets: ['AI search visibility audit', 'Content structured for LLM citation', 'Authority signals for AI discovery', 'Ongoing GEO monitoring and reporting'], price: $("800/mo"), cta: 'Learn More' },
  { title: 'E-Commerce Marketing', slug: '/services/ecommerce-marketing', label: 'E-Commerce', img: 'https://images.pexels.com/photos/230544/pexels-photo-230544.jpeg?auto=compress&cs=tinysrgb&w=800', alt: 'E-commerce and online shopping', headline: 'More traffic. More sales. Less wasted spend.', desc: 'End-to-end digital marketing for online stores. SEO, Google Shopping, Meta ads, and email automation focused on revenue.', bullets: ['Google Shopping and Performance Max', 'Meta product ads', 'E-commerce SEO and category pages', 'Email flows: abandoned cart, post-purchase'], price: $("1,200/mo"), cta: 'Get a Free Audit' },
]
            ...
            <div className="svc-list">
              {services.map((s, i) => (
                <div key={s.slug} className={i % 2 === 1 ? 'svc-card svc-card--flip' : 'svc-card'}>
                  ...
                  <div className="svc-card__visual">{s.img ? <img src={s.img} alt={s.alt} className="svc-card__img" /> : <span className="svc-card__name">{s.title}</span>}</div>
                </div>
              ))}
            </div>
          </div>
