...
const industries = [
  { slug: 'contractors', img: 'https://images.pexels.com/photos/1216589/pexels-photo-1216589.jpeg?auto=compress&cs=tinysrgb&w=800', alt: 'Contractor at work on a job site', name: 'Contractors and Trades', icon: 'T', headline: 'Marketing for Local Contractors and Trades', desc: 'Plumbers, electricians, roofers, HVAC techs. We build the digital presence that keeps your phone ringing. Local SEO, Google Ads, and websites built to generate service calls.', services: ['Local SEO and map pack rankings', 'Google Ads for service calls', 'Website built for conversions', 'Google Business Profile optimization'], result: 'Most trade businesses see a 2-3x increase in inbound leads within 90 days.' },
  { slug: 'hvac', img: 'https://images.pexels.com/photos/4489732/pexels-photo-4489732.jpeg?auto=compress&cs=tinysrgb&w=800', alt: 'HVAC technician servicing equipment', name: 'HVAC and Heating', icon: 'H', headline: 'Digital Marketing for HVAC Companies', desc: 'Heating and cooling is seasonal, competitive, and search-driven. We help HVAC companies dominate local search, run profitable campaigns, and convert more visitors.', services: ['Emergency service keyword targeting', 'Seasonal Google Ads campaigns', 'Local SEO for multiple service areas', 'Review and reputation management'], result: 'Our HVAC clients average 40% more booked jobs during peak season.' },
  { slug: 'landscaping', img: 'https://images.pexels.com/photos/1084540/pexels-photo-1084540.jpeg?auto=compress&cs=tinysrgb&w=800', alt: 'Beautiful landscaped garden', name: 'Landscaping', icon: 'L', headline: 'Marketing for Landscaping Companies', desc: 'We help you rank in the neighbourhoods you serve, run seasonal ad campaigns, and build a brand people trust.', services: ['Neighbourhood-level local SEO', 'Before and after portfolio pages', 'Seasonal Google and Meta ads', 'Google Business Profile management'], result: 'Landscaping clients see strong lead growth heading into spring season.' },
  { slug: 'restaurants', img: 'https://images.pexels.com/photos/262978/pexels-photo-262978.jpeg?auto=compress&cs=tinysrgb&w=800', alt: 'Restaurant interior with warm lighting', name: 'Restaurants and Cafes', icon: 'R', headline: 'Digital Marketing for Restaurants and Cafes', desc: 'We optimize your Google presence, manage reviews, run social ads, and build websites that turn searches into reservations.', services: ['Google Business Profile and Maps optimization', 'Review generation and management', 'Instagram and Facebook ad campaigns', 'Local keyword targeting'], result: 'Restaurant clients have seen up to 40% more direct reservations.' },
  { slug: 'hotels', img: 'https://images.pexels.com/photos/271624/pexels-photo-271624.jpeg?auto=compress&cs=tinysrgb&w=800', alt: 'Elegant hotel lobby', name: 'Hotels and Hospitality', icon: 'O', headline: 'Digital Marketing for Hotels and Hospitality', desc: 'We help independent hotels rank in direct search, run Google Hotel Ads, and convert more organic traffic to direct bookings.', services: ['Direct booking SEO strategy', 'Google Hotel Ads management', 'Local and travel keyword targeting', 'Conversion-focused website design'], result: 'Hotel clients have achieved 2x direct booking rates year over year.' },
  { slug: 'lawyers', img: 'https://images.pexels.com/photos/5669619/pexels-photo-5669619.jpeg?auto=compress&cs=tinysrgb&w=800', alt: 'Law office professional setting', name: 'Lawyers and Law Firms', icon: 'J', headline: 'Legal Marketing for Law Firms in Toronto', desc: 'We help law firms rank for the practice areas that matter, generate quality leads, and build authority online.', services: ['Practice area keyword targeting', 'Google Ads for legal services', 'E-E-A-T content and authority building', 'Google Business Profile for law firms'], result: 'Law firm clients see significant improvement in qualified lead volume.' },
  { slug: 'medical', img: 'https://images.pexels.com/photos/4021775/pexels-photo-4021775.jpeg?auto=compress&cs=tinysrgb&w=800', alt: 'Clean medical clinic reception', name: 'Dentists and Medical Clinics', icon: 'D', headline: 'Digital Marketing for Dental and Medical Clinics', desc: 'We help dental and medical practices rank, generate new patient inquiries, and build trust through reviews and local SEO.', services: ['New patient acquisition SEO', 'Google Ads for dental procedures', 'Review strategy and reputation management', 'Local map pack optimization'], result: 'Dental clients consistently grow new patient bookings through organic search.' },
]
